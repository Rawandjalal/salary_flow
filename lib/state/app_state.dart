...
class AppState extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedStrings = {
    'en': {
      ...
      'task_added_msg': 'Task added — you\'ll be notified when it\'s due!',
      'task_done': 'Done',
      'd_overdue': 'd overdue',
      'h_overdue': 'h overdue',
      'm_overdue': 'm overdue',
      'in_prefix': 'in ',
      'due_now': 'Due now!',
      'task_cat_shopping': 'Shopping',
      'task_cat_food': 'Food',
      'task_cat_bills': 'Bills',
      'task_cat_savings': 'Savings',
      'task_cat_health': 'Health',
    ...
    'ku': {
      ...
      // Tasks Page Keys Kurdish
      'tasks_title': 'ئەرکەکان و بیرخەرەوەکان',
      'tasks_pending': 'چاوەڕوانکراو',
      'upcoming_tasks': 'ئەرکەکانی داهاتوو',
      'completed_tasks': 'تەواوکراو',
      ...
      'notes_hint': 'وردەکاری زیاتر...',
      'estimated_cost': 'خەرجی خەمڵێندراو (ئارەزوومەندانە)',
      'task_category': 'هاوپۆل',
      'due_date_time': 'ڕێکەوت و کاتی کۆتایی',
      'update_task': 'نوێکردنەوەی ئەرک',
      'add_task_reminder': 'زیادکردنی ئەرک + بیرخەرەوە',
      'no_tasks_yet': 'هیچ ئەرکێک نییە',
      'no_tasks_desc': 'ئەرکەکانت لێرە زیاد بکە وەک "کڕینی غاز" یان "دانی پسوولە"\nبۆ ئەوەی لە کاتی خۆیدا ئاگادارت بکەینەوە.',
      'create_first_task': 'دروستکردنی یەکەم ئەرک',
      'preset_tomorrow': 'بەیانی',
      'enter_title_error': 'تکایە ناونیشانی ئەرکەکە بنووسە',
      'task_updated_msg': 'ئەرکەکە نوێکرایەوە ✓',
      'task_added_msg': 'ئەرکەکە زیادکرا — کاتی خۆی ئاگادارت دەکەینەوە!',
      'task_done': 'تەواو بوو',
      'd_overdue': 'ڕۆژ دواکەوتووە',
      'h_overdue': 'کاتژمێر دواکەوتووە',
      'm_overdue': 'خولەک دواکەوتووە',
      'in_prefix': 'پاش ',
      'due_now': 'ئێستا کۆتایی دێت!',
      'task_cat_shopping': 'بازاڕکردن',
      'task_cat_food': 'خۆراک',
      'task_cat_bills': 'پسوولەکان',
      'task_cat_savings': 'پاشەکەوت',
      'task_cat_health': 'تەندروستی',
